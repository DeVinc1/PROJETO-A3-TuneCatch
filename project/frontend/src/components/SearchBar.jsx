...
function SearchBar() {
  ...
  return (
    ...
    <div className="flex items-center bg-[#FFF9F9] p-4 rounded-lg w-1/2">
      ...
      {/* Botão de Lupa (separado) - Cor alterada para #0F1108 */}
      <button
        onClick={handleSearch}
        className="flex items-center justify-center w-10 h-10 rounded-full text-[#0F1108] transition-colors duration-300 mr-8" // Cor da lupa alterada
